...
const RegisterForm = ({
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-slate-100/70 border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-2xl">
      {/* Header */}
      <div className="bg-gradient-to-r from-indigo-500 to-sky-500 p-6 text-white text-center">
        <h2 className="text-xl font-bold tracking-wide">
          Join Villgo Partner Network
        </h2>

        <p className="text-sky-100 text-xs mt-1">
          Directly trade, supply, and deliver across rural & urban hubs
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="p-6 sm:p-8 space-y-4">
        ...
        {role === "wholesaler" && (
          <p className="text-[10px] text-amber-600 bg-amber-50 border border-amber-100 p-2 rounded-lg">
            ⚠️ Wholesaler accounts require admin approval.
          </p>
        )}
        ...
        <div className="flex items-start gap-2">
          ...
          >
            I agree to Villgo Partner Agreement &
            Freight Terms.
          </label>
        </div>
        ...
        <button
          ...
          className="w-full py-3 border border-slate-300 rounded-2xl hover:bg-slate-100 font-semibold transition"
        >
          Already have an account? Login
        </button>
      </form>
