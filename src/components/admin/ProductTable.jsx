...
export default function ProductTable({
  ...
  onRestore = () => { },
  onEdit = () => { },
  apiHost = "http://localhost:8080",//https://villgo-backend-1.onrender.com",
  theme = "light"
}) {
  ...
  const handleCategorySubmit = async (e) => {
    ...
    if (!categoryModal.image && !categoryModal.isEdit) {
        showToast("Please select category image", "error");
        return;
    }
    setLoading(true);
    try {
